...
namespace primal::tools
{
	...
	inline u64 BitsPerPixel(MTLPixelFormat fmt)
	{
		switch (fmt)
		{
	...
	inline u64 BitsPerColor(MTLPixelFormat fmt)
	{
		switch (fmt)
		{
	...
	inline bool IsBGR(MTLPixelFormat fmt)
	{
		return fmt == MTLPixelFormatBGRA8Unorm;
	}
