...
#include "Graphics/RHI/Components/RHICamera.h"
...
class TestParticleSponza : public primal::test::RenderTestCase {
public:
    virtual ~TestParticleSponza();
...
private:
    ...
    primal::utl::vector<primal::graphics::SceneDataMeshInfo> sceneMeshes;
    ...
    primal::graphics::rhi::ResourceHandle defaultMaterialSet = primal::graphics::rhi::handles::INVALID_DESCRIPTOR_SET;
    ...
    static TestParticleSponza* instance;
    ...
    primal::utl::vector<std::string> _pendingTexturePaths;
