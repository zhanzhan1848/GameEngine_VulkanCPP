...
namespace PrimalEditor
{
    ...
    public static class ContentHelper
    {
        ...
        internal static async Task<List<Asset>> ImportFileAsync(IEnumerable<AssetProxy> proxies)
        {
    ...
    static class BitmapHelper
    {
        ...
        {
            var scaleX = maxWidth / (int)image.PixelWidth;
            var scaleY = maxHeight / (int)image.PixelHeight;
