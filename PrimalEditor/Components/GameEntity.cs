            ...
            set
            {
                if(_isActive != value)
                {
                    ...
                    if(_isActive)
                    {
                        ...
                        System.Diagnostics.Debug.Assert(ID.IsValid(_entityId));
                    }
    ...
    abstract class MSEntity : ViewModelBase
    {
        ...
        private void MakeComponentList()
        {
            ...
            foreach(var component in firstEntity.Components)
            {
                ...
                {
                    System.Diagnostics.Debug.Assert(Components.FirstOrDefault(x => x.GetType() == type) == null);
        ...
        {
            System.Diagnostics.Debug.Assert(entities?.Any() == true);
