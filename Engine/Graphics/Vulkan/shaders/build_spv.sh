...
LUMEN_GLSL_NAMES=( "Lumen/SSAOTrace" "Lumen/SSAOFilter" "Lumen/DDGIGIGather" "Lumen/FusionIndirect" "Lumen/FusionComposite" "Lumen/DDGITraceRays" "Lumen/DDGIUpdateIrradiance" "Lumen/DDGIUpdateDepth" "Lumen/SSGITrace" )
LUMEN_GLSL_ENTRIES=( "ssao_trace" "ssao_filter" "ddgi_gi_gather" "fusion_indirect" "fusion_composite" "ddgi_trace_rays" "ddgi_update_irradiance" "ddgi_update_depth" "ssgi_trace" )
LUMEN_GLSL_STAGES=( "comp" "comp" "comp" "frag" "frag" "comp" "comp" "comp" "comp" )
