...
// T4.6.5 part 10 — Vulkan port of Forward/GBufferAlphaClip.metal vertex stage.
// Entry point: main
//
// Identical to GBuffer.vert — the alpha-clip variant only differs in the
// fragment stage (alpha-tested discard). Vertex transformation is shared.
//
...
void main() {
    ...
    // V-flip UV to match Metal convention (GBufferAlphaClip.metal:124 mirrors GBuffer.metal)
