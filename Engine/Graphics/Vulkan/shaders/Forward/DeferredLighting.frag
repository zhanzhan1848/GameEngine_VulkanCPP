...
// VSM blurred RG32 shadow moments per cascade (Chebyshev upper bound).
layout(set = 0, binding = 13) uniform texture2D shadowMoments0;
layout(set = 0, binding = 14) uniform texture2D shadowMoments1;
