...
namespace primal::graphics::vulkan
{
	...
	namespace materials
	{
		...
		/// <summary>
		///  ��һ��material�ڵ�ͼƬ��ID��2������ɣ���һ������ͼƬ��ԭʼID���ڶ���������material�ڵ�copy_id
		///   material�ڵ�ID��ԭʼID��Ϊͷ16λ��copy_id��Ϊ��16λ
		/// </summary>
		/// <param name="path"></param>
		...
		/// 
		/// </summary>
		/// <param name="id">��IDӦΪmaterial�ڵ���Ϻ��ID</param>
