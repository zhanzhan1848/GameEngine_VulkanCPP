// Engine/Graphics/WFC/WFCObserver.cpp
...
void WFCObserver::Initialize(const WaveGrid& grid) {
    heap_.clear();
...
void WFCObserver::OnCellChanged(WFCGridCoord c) {
...
WFCGridCoord WFCObserver::PickNextCollapse(const WaveGrid& grid) {
    while (!heap_.empty()) {
