...
namespace primal::graphics::d3d12
{
	...
	public:
		...
		constexpr d3d12_surface(d3d12_surface&& o)
			: _swap_chain{ o._swap_chain }, _window{ o._window }, _current_bb_index{ o._current_bb_index }, _viewport{ o._viewport },
			_scissor_rect{ o._scissor_rect }, _allow_tearing{ o._allow_tearing }, _present_flags{ o._present_flags }, _light_culling_id{ o._light_culling_id }
		{
			for (u32 i{ 0 }; i < buffer_count; ++i)
			{
				_render_tardata::get_data[i].resource = o._render_tardata::get_data[i].resource;
				_render_tardata::get_data[i].rtv = o._render_tardata::get_data[i].rtv;
			}
		...
		[[nodiscard]] constexpr const id::id_type light_culling_id() const { return _light_culling_id; }
	...
	private:
		...
		constexpr void move(d3d12_surface& o)
		{
			...
			for (u32 i{ 0 }; i < buffer_count; ++i)
			{
				_render_tardata::get_data[i] = o._render_tardata::get_data[i];
			}
			_window = o._window;
		...
		//		as well as the move() and reset() function. This is to have the currect behavior when
		//		using std::vector (from STL)
