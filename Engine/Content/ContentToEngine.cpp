...
namespace primal::content
{
	...
	{
		assert(data);
		std::cout << "ContentToEngine::create_resource called with type: " << type << std::endl;
		...
		case asset_type::mesh:				
			std::cout << "Calling create_geometry_resource..." << std::endl;
			id = create_geometry_resource(data);						
			std::cout << "create_geometry_resource returned id: " << id << std::endl;
			break;
