...
public:
    ...
    void set_texture(primal::graphics::rhi::ResourceHandle texture);
    primal::graphics::rhi::ResourceHandle get_texture() const { return _texture; }
...
private:
    ...
    emitter_id _id;
    primal::graphics::rhi::ResourceHandle _texture{ primal::graphics::rhi::handles::INVALID_RESOURCE };
