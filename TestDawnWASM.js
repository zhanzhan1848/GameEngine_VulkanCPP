...
var ASM_CONSTS = {
 ...
 7757598: ($0, $1, $2) => { if (window.setRenderMode) { window.setRenderMode($0, UTF8ToString($1), UTF8ToString($2)); } },  
 7757694: ($0) => { if (window.setMeshletDebug) { window.setMeshletDebug($0); } }
};
