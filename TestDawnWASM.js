...
var ASM_CONSTS = {
 ...
 7757998: ($0, $1, $2) => { if (window.setRenderMode) { window.setRenderMode($0, UTF8ToString($1), UTF8ToString($2)); } },  
 7758094: ($0) => { if (window.setMeshletDebug) { window.setMeshletDebug($0); } }
};
