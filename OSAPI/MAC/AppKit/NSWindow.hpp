...
// 以下方法为自定义方法
_NS_INLINE void NS::Window::setFrame( CGRect frame, bool display )
{
	Object::sendMessage< void >( this, _APPKIT_PRIVATE_SEL( setFrame_display_ ), frame, display );
}
...
_NS_INLINE void NS::Window::setTitle(const char* title)
{
	NS::String* nsTitle = NS::String::string(title, NS::StringEncoding::UTF8StringEncoding);
	setTitle(nsTitle);
}